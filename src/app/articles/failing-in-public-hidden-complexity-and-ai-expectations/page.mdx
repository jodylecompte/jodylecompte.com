...
I did not want just "looks like a book". I wanted it to feel like Jonathan Edwards had written _Sinners in the Hands of an Angry God_ directly in markdown for a web-first experience.
...
That is why a small local model felt like enough. You do not need a frontier model to tell a heading from a paragraph. Getting one running locally for this project was the subject of the first post in this track, [That's It? Running a Local LLM in 2026](https://www.jodylecompte.com/articles/thats-it-local-llm-in-2026).
...
and a quick inspection didn't reveal anything obviously broken. It was enough to convince me that the normalization step was basically solved.
...
Just Prompt Better(&trade;) wasn't going to save me. My architecture was fundamentally wrong, I just
didn't know it yet.
...
it just couldn't infer semantic structure. The LLM approach broke for the opposite reason: it had the
...
Each of these decisions made sense at the time. It makes me wonder how much the velocity of AI assisted development
will cause things to be missed, not because of poor AI quality or operator negligence, but because some issues evolve
slowly in codebases and bad decisions now snowball much faster.

I am not discouraged by how this ended. Definitely humbled, maybe a little frustrated, but mostly determined. We can
generate code faster than ever, yet there I was fighting a broken prototype. I feel better prepared to tackle the
problem, and I think I can make it work without resorting to hosted models or loosening constraints.

I will need to narrow the scope. The metadata will remain organic, grass fed, and written by humans. That is about all
I have decided so far. With some work and some luck, there may be a part two where I describe my redemption arc to a working
pipeline.
